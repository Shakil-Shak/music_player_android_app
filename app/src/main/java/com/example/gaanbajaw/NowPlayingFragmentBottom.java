...
import static com.example.gaanbajaw.MainActivity.ARTIST_TO_FRAG;
import static com.example.gaanbajaw.MainActivity.PATH_TO_FRAG;
import static com.example.gaanbajaw.MainActivity.SHOW_MINI_PLAYER;
import static com.example.gaanbajaw.MainActivity.SONG_NAME_TO_FRAG;
...
public class NowPlayingFragmentBottom extends Fragment implements ServiceConnection {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (musicService != null){
                    ...
                    editor.putString(SONG_NAME,musicService.musicFiles.get(musicService.position).getTital());
                    editor.apply();
                        ...
                        if (SHOW_MINI_PLAYER){
                            ...
                            if (PATH_TO_FRAG != null){
                                ...
                                if (art!=null){
                                    ...
                                    Glide.with(getContext()).load(R.drawable.play).into(albumArt);
        ...
        playPauseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (musicService != null){
                    musicService.playPausetBtnClicked();
